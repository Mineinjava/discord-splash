...
class Channel():
    ...
    def __init__(self, jsonData : dict):
        ...
        self.permission_overwrites         = self.channelData.get("permission_overwrites?")                        # TODO: Add an Overwrite object - https://discord.com/developers/docs/resources/channel#overwrite-object
        ...
        self.thread_metadate               = self.channelData.get("thread_metadata?")                              # TODO: Add a Thread Metadata object - https://discord.com/developers/docs/resources/channel#thread-metadata-object
        self.member                        = self.channelData.get("member?")                                       # TODO: Add a Thread Member object - https://discord.com/developers/docs/resources/channel#thread-member-object
